...
This is the whole answer to the constraint that runs through this project. Qt
relocates menu items on macOS by matching their text, clips layouts differently
under a device pixel ratio that is always an integer there, and picks a system
font nobody here can preview. None of that is visible from Windows, and none of
it is visible from a passing test suite. A picture is.
